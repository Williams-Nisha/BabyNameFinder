...
<div class="logo"><a href="/"><img id="logo" src="/images/logo1.png" alt="logo for baby name app" height="100" width="100"></a></div>
        <div class="tagline">Baby Name Finder</div>
...
<!--      Navigation code for future use
<nav class="nav">
           <ul class="nav-list">
                <li class="nav-link"><a href="/">Home</a></li>
